...
import { DynamicAdvancedAnalytics } from '@/components/performance/DynamicImports'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">지점별 사용자 미션 현황 및 고급 분석</p>
      </div>
          ...
          {stats && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{stats.totalMissions ? stats.totalMissions.toLocaleString() : '0'}</div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{stats.totalPayback ? stats.totalPayback.toLocaleString() : '0'}원</div>
                </CardContent>
              </Card>
            </div>
          )}
      ...
      <Card>
                ...
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={columns.length} className="h-24 text-center">
                      ...
                      <p className="text-gray-500 mb-2">미션 데이터가 없습니다.</p>
                      <p className="text-sm text-gray-400">사용자가 아직 미션에 참여하지 않았습니다.</p>
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <DynamicAdvancedAnalytics adminId={adminId} />
        </TabsContent>
      </Tabs>
    </div>
  )
